...
For development, use the `--generate-dev-certs` flag to auto-generate self-signed ECDSA P-256 certificates. **Never use self-signed certificates in production.**
